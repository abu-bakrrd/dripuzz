...
2. **Списки товаров (В наличии)**:
   {номер}. <b><a href="https://monvoir.shop/product/{id}">{Name}</a></b> — {Price} сум ✅ В наличии
...
- **Никаких цифр в остатках**: ЗАПРЕЩЕНО писать "2 шт", "5 шт" и т.д. Только "✅ В наличии".
- **Формат цены**: Пиши с разделителем тысяч (например, 349,000 сум).
- **Никаких повторов**: Не пиши "У нас есть Пальто: Пальто". Сразу переходи к сути.
- **Ссылки**: Никаких URL рядом в скобках. Только жирная ссылка на названии.
...
2. Никаких цифр количества товара.
3. Никаких тегов `<br>`.
"""
