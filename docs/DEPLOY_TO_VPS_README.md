...
## 📦 Вариант 1: Мастер-развертывание (Рекомендуется) 🔥

Это самый быстрый и полный способ установки. Скрипт сам установит все зависимости, настроит базу данных, Nginx и всех ботов.
...
### Шаг 2: Запустите мастер-установку
